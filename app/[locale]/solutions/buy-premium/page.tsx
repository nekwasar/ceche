    ...
    <main className="min-h-screen bg-[#FAF7F2] text-[#111]">
      ...
      <section className="max-w-2xl mx-auto px-4 md:px-6 pb-16 md:pb-20">
        {[
          ...
          { step: "2", title: "Negotiate & Transact", desc: "Make offers, counter-offers, and close deals securely through our escrow system. Funds are held until domain transfer is confirmed and verified." },
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-6 pb-16 md:pb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {[
            { icon: "🔒", title: "Escrow Protection", desc: "Funds held securely in escrow until domain transfer is confirmed and verified by both parties." },
            ...
            <table className="w-full border-collapse text-sm min-w-[500px]">
              ...
              <tbody>
                {[
                  ...
                  { type: "Escrow Fee", amount: "Included", notes: "No extra charge for escrow protection" },
                ].map((r, i) => (
      ...
      <section className="bg-[#111] py-16 md:py-20 px-4 md:px-6 text-center">
        ...
        <p className="text-base md:text-lg text-white/70 max-w-lg mx-auto mb-8">
          Secure, transparent transactions with escrow protection on every purchase.
        </p>
