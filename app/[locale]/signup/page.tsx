      ...
      <div className="w-full max-w-md p-8 border border-border rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} required className="w-full border border-border rounded-md px-3 py-2 bg-background" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={8} className="w-full border border-border rounded-md px-3 py-2 bg-background" />
          </div>
